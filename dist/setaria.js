...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue'), require('lodash'), require('moment'), require('moment/locale/zh-cn'), require('axios'), require('vuex')) :
	typeof define === 'function' && define.amd ? define(['vue', 'lodash', 'moment', 'moment/locale/zh-cn', 'axios', 'vuex'], factory) :
	(global.Setaria = factory(global.Vue$1,global._,global.moment,null,global.axios,global.Vuex));
}(this, (function (Vue$1,_,moment,moment_locale_zhCn,axios,Vuex) { 'use strict';
