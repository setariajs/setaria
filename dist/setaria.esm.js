...
ErrorHandler.handleError = function handleError (
  ...
  // 生产环境不显示部分错误类型
  var isIgnoreErrorFlag = process.env.NODE_ENV === 'production' && isIgnoreError(error);
  var storeInstance = getStore();
...
export { ApplicationError, constants, defaultConfig, Message, ServiceError, index as StoreGlobalAPI, index$1 as util };export default Setaria;
